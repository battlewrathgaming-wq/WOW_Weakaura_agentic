...
| **The supertracker's live tenant is the QUEST waypoint, and it is BLIND to what wrote it** | addons · Battlewrath 2026-08-16. **There is no ownership to arbitrate** — a player who wants it back just opens their journal. ⚠ Nothing recorded this, and its absence let a whole design conversation treat *"who owns the slot"* as a contest between our own modules when the incumbent was always the player's quest arrow |
