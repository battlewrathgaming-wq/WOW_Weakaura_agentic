...
holder:  addons bench
since:   2026-08-13
heading: Building the WORLD MAP fact basis from the client DBCs — a bench asset, not Dungeon_run-scoped.
runway:  medium — DBC read, emitter, fact basis, verified against the two pinned runs.
