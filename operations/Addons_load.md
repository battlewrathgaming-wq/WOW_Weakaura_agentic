...
## ▶ ACTIVE — `COA_DungeonRun` → **brief: `addons/planning/dungeonrun_poc.md` (47 sections)**
...
§1-§16 capture · §17-§27 + §38-§40 display · §29-§37 + §41-§47 the promotion model + curation. **§29 is the
