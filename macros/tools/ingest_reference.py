    ...
    payload = {
        "local_witnesses_first": {
            "why": "Battlewrath, 2026-07-17: 'a lot of the state reading is already well "
                   ...
                   "exists so reasoning READS instead of re-deriving, and a LOCAL sourced "
                   "witness (the installed fork's own Types.lua) beats any retail doc. "
                   "Local witnesses are joined FIRST.",
            "NOT_redundant_with_the_wikis": "Battlewrath, 2026-07-17: 'This is discovery. "
                                            "Using our internal data is just leveraging the "
                                            "investments, not an error.' Correct, and worth "
                                            "stating precisely: the sheets carry ZERO "
                                            "conditionals (42 of the candidates are flags), "
                                            "OMIT `mouseover` (the most-used macro target), "
                                            "and carry no patch dating - they could not have "
                                            "answered the question. Overlap = 11 unit tokens, "
                                            "where they are the STRONGER witness. "
                                            "COMPLEMENTARY, not redundant: the JOIN is the "
                                            "value, and the one sharp find (@nameplate "
                                            "live-proven WITH boundary semantics) needed both "
