...
def w3_2():
    ...
    print("   W3.2 - THE BAND")
    print("   " + "-" * 68)
    print("   ★★★ WHAT IT IS (Battlewrath, §287): 2.5 yd, \"am I in this height\", as a")
    print("   REJECT CHECK applied once x,y is ALREADY inside R. Not a trajectory, not a")
    print("   jump model - one comparison after the radius has already passed.")
    print("")
    print("   ★★ THE GUARD, and it is the reason to prefer tight over generous:")
    print("")
    print("       too TIGHT   the beacon does not fire. The author SEES it and adjusts.")
    print("       too LOOSE   it reads THROUGH A FLOOR - invisible to the author, in a")
    print("                   place they did not choose, and unfixable by placement.")
    print("")
    print("   The failure modes are not symmetric in CONSEQUENCE. Everything else about")
    print("   the band is the author’s to catch by placement; a permissive bandUp is the")
    print("   one thing that is not. So it errs tight ON PRINCIPLE, not because geometry")
   
    print("   demands it - and no amount of position data could have said that.")
    print("")
    print("   ⚠ THE MEASUREMENTS BELOW ARE INPUTS TO THAT TOLERANCE, NOTHING MORE.")
    print("   I spent several turns deriving a jump apex to 4 decimal places. The fence")
    print("   at the head of this file already called that out of scope, and I wrote it")
    print("   one commit before doing it. The numbers are kept because they are cheap")
    print("   and real; they are not what the band is FOR.")
    print("")
    ...
    print("")
    print("")
    print("(ii) jump apex - MEASURED §284, one line because that is all it warrants")
    print("     true apex in [1.6404, 1.7368]; zspeed 8.0 gives 1.6588, the only")
     
    print("     candidate in range. 1.27 and 1.5 excluded below, our own §73 1.9 above.")
    print("     ⚠ It does not size the band: a jump is TRANSIENT and the player lands")
     
    print("       back on the floor, so the beacon fires on landing regardless.")
    ...
    print("")
    print("   " + "-" * 68)
    print("   admit  jitter %.4f (measured)      reject  a %s yd stack (measured)"
          % (jit, ("%.2f" % tight) if tight else "?"))
    print("   BAND = 2.5 yd, both directions, ERRING TIGHT. Not ruled here - stated so",
          "the")
    print("   readout carries the same number the driver does. See the head of this",
          "section")
    print("   for why tight rather than generous.")
    print("")
    return 0
