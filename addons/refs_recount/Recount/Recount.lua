...
local Default_Profile={
	profile={
		Colors={
			...
			["Class"]={
				["HUNTER"] = { RAID_CLASS_COLORS["HUNTER"]:GetRGBA() },
				["WARLOCK"] = { RAID_CLASS_COLORS["WARLOCK"]:GetRGBA() },
				["PRIEST"] = { RAID_CLASS_COLORS["PRIEST"]:GetRGBA() },
				["PALADIN"] = { RAID_CLASS_COLORS["PALADIN"]:GetRGBA() },
				["MAGE"] = { RAID_CLASS_COLORS["MAGE"]:GetRGBA() },
				["ROGUE"] = { RAID_CLASS_COLORS["ROGUE"]:GetRGBA() },
				["DRUID"] = { RAID_CLASS_COLORS["DRUID"]:GetRGBA() },
				["SHAMAN"] = { RAID_CLASS_COLORS["SHAMAN"]:GetRGBA() },
				["WARRIOR"] = { RAID_CLASS_COLORS["WARRIOR"]:GetRGBA() },
				["DEATHKNIGHT"] = { RAID_CLASS_COLORS["DEATHKNIGHT"]:GetRGBA() },
				["HERO"] = { RAID_CLASS_COLORS["HERO"]:GetRGBA() },
				["NECROMANCER"] = { RAID_CLASS_COLORS["NECROMANCER"]:GetRGBA() },
				["PYROMANCER"] = { RAID_CLASS_COLORS["PYROMANCER"]:GetRGBA() },
				["CULTIST"] = { RAID_CLASS_COLORS["CULTIST"]:GetRGBA() },
				["STARCALLER"] = { RAID_CLASS_COLORS["STARCALLER"]:GetRGBA() },
				["SUNCLERIC"] = { RAID_CLASS_COLORS["SUNCLERIC"]:GetRGBA() },
				["TINKER"] = { RAID_CLASS_COLORS["TINKER"]:GetRGBA() },
				["SPIRITMAGE"] = { RAID_CLASS_COLORS["SPIRITMAGE"]:GetRGBA() },
				["WILDWALKER"] = { RAID_CLASS_COLORS["WILDWALKER"]:GetRGBA() },
				["REAPER"] = { RAID_CLASS_COLORS["REAPER"]:GetRGBA() },
				["PROPHET"] = { RAID_CLASS_COLORS["PROPHET"]:GetRGBA() },
				["CHRONOMANCER"] = { RAID_CLASS_COLORS["CHRONOMANCER"]:GetRGBA() },
				["SONOFARUGAL"] = { RAID_CLASS_COLORS["SONOFARUGAL"]:GetRGBA() },
				["GUARDIAN"] = { RAID_CLASS_COLORS["GUARDIAN"]:GetRGBA() },
				["STORMBRINGER"] = { RAID_CLASS_COLORS["STORMBRINGER"]:GetRGBA() },
				["DEMONHUNTER"] = { RAID_CLASS_COLORS["DEMONHUNTER"]:GetRGBA() },
				["BARBARIAN"] = { RAID_CLASS_COLORS["BARBARIAN"]:GetRGBA() },
				["WITCHDOCTOR"] = { RAID_CLASS_COLORS["WITCHDOCTOR"]:GetRGBA() },
				["WITCHHUNTER"] = { RAID_CLASS_COLORS["WITCHHUNTER"]:GetRGBA() },
				["FLESHWARDEN"] = { RAID_CLASS_COLORS["FLESHWARDEN"]:GetRGBA() },
				["MONK"] = { RAID_CLASS_COLORS["MONK"]:GetRGBA() },
				["RANGER"] = { RAID_CLASS_COLORS["RANGER"]:GetRGBA() },
