...
| ★★ **the driver INFORMS, it never grades** | completion counts, "you missed one", scores, streaks. It says where things are; what that is worth is not ours to say | **forecast** — no code carries this yet |
