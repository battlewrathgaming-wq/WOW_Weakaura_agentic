...
| ★★ **the driver INFORMS, it never grades** | completion counts, "you missed one", scores, streaks. It says where things are; what that is worth is not ours to say | ⌛ awaiting code · `planning/debug_suite_plan.md` |
