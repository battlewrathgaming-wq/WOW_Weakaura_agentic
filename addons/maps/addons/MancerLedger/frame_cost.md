# Frame cost — MancerLedger

_Emitted by `addons/tools/emit_addon_census.py`. Never hand-edited._
_Source fingerprint `8d142c84eb7c` — run `py addons/tools/emit_addon_census.py --check` to find out if this has gone stale._
...
| `minimap.lua` | 3 | 1 | **MIXED** — 2 persistent | yes |

**4 handler(s) installed; 3 PERSISTENT.** The persistent ones are the whole point of this page.
...
| File | Detail |
|---|---|
| `core.lua` | ADDON_LOADED, PLAYER_ENTERING_WORLD, PLAYER_REGEN_ENABLED |
