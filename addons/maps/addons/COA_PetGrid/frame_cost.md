...
| File | Detail |
|---|---|
| `feed_live.lua` | `COMBAT_LOG_EVENT_UNFILTERED` |
...
| `feed_live.lua` | COMBAT_LOG_EVENT_UNFILTERED, PLAYER_REGEN_DISABLED, PLAYER_REGEN_ENABLED |
