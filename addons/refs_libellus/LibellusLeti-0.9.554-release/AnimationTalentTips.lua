...
Mancer.AnimationTalentTips = {
    ...
    statScales = {
        ...
        ["Raise: Decaying Colossus"] = { "int", "hst" },
    ...
    tips = {
        ...
        ["Raise: Decaying Colossus"] = {
            verdict = "situational",
            headline = "3 Life Force — personal damage sponge",
            lines = {
                "While up, 25% of damage you take is shifted to the Colossus.",
                "Does not enable Army of the Dead — that still needs Raise: Abomination.",
                "Take for survivability on hard content, not as your boss DPS Raise.",
            },
        },
        ["Raise: Flesh Golem"] = {
            verdict = "math_first",
        ...
        ["Grim Mandate"] = {
            ...
            lines = {
                ...
                "One of Libellus Leti’s four “keep up” buffs for Animation.",
            },
        },
        ["Razorice"] = {
            verdict = "math_first_s",
        ...
        ["Bone Ward"] = {
            ...
            lines = {
                "Best general Ward: +50% armor and +10% stamina on you and your Undead.",
                "Best for Abomination / Decaying Colossus style play, tankiness, and Sepulchral side value.",
                "Only one Ward can be active — default to Bone Ward unless you are chasing ghoul-heavy offense.",
                "One of Libellus Leti’s four “keep up” buffs for Animation.",
            },
        },
        ["Chill of the Tomb"] = {
        ...
        ["Fetid Ward"] = {
            ...
            lines = {
                "Bone Ward is the stronger default Ward (armor + stamina on you and your Undead).",
                "Only one Ward can be active — prefer Bone Ward over Fetid Ward.",
            },
        },
        ["Glacial Ward"] = {
            verdict = "situational",
            headline = "Ghoul offense niche — otherwise prefer Bone Ward",
            lines = {
                "Only one Ward can be active at a time.",
                "Glacial Ward gives +10% Intellect, which directly boosts ghoul offense in Libellus Leti's paper math.",
                "Default: Bone Ward. Swap to Glacial only for ghoul-centric offense; keep Chill of the Tomb for the chill slot.",
            },
        },
        ["Foul Mandate"] = {
            verdict = "situational",
    ...
    spellIds = {
        ...
        [500989] = "Raise: Decaying Colossus",
...
function Mancer.AnimationTalentTips.PrintBuffGuide()
    ...
    Mancer.Print("       Default Ward: +50% armor and +10% stamina on you and your Undead.")
    Mancer.Print("       Best general / colossus Ward; strongest for tankiness and stamina-side value.")
    Mancer.Print("")
    Mancer.Print("     Glacial Ward")
    Mancer.Print("       Ghoul-offense niche: +10% Intellect directly boosts ghoul paper damage/healing.")
    Mancer.Print("       Use it when you want ghoul-centric offense, not as the default general Ward.")
    Mancer.Print("")
    ...
    Mancer.Print("  Swap Bone Ward → Glacial Ward only when you specifically want ghoul-heavy offense over general Ward value.")
    Mancer.Print("  Hover a Ward / Mandate on your bars — Libellus Leti tips mark Preferred vs Prefer X instead.")
end
