...
GetTabDefs = function()
    local Loc = Mancer.Loc or function(key, fallback)
        return fallback or key
    end
    return {
        {
            id = "combat",
            label = Loc("HUB_TAB_COMBAT", "Combat"),
            subtitle = Loc("HUB_TAB_COMBAT_SUB", "Army · LF · DPS"),
            tip = Loc("HUB_TAB_COMBAT_TIP", "Army picks, Life Force, DPS, and ST vs AoE"),
            icon = "Interface\\Icons\\Spell_Shadow_DeathCoil",
        },
        {
            id = "minions",
            label = Loc("HUB_TAB_MINIONS", "Minions"),
            subtitle = Loc("HUB_TAB_MINIONS_SUB", "Guardian sheet"),
            tip = Loc("HUB_TAB_MINIONS_TIP", "Live guardian sheet — stats and model"),
            icon = "Interface\\Icons\\Spell_Shadow_AnimateDead",
        },
        {
            id = "theory",
            label = Loc("HUB_TAB_GUIDES", "Guides"),
            subtitle = Loc("HUB_TAB_GUIDES_SUB", "Stats · Paper · Buffs"),
            tip = Loc("HUB_TAB_GUIDES_TIP", "Stat caps, paper DPS, and buff picks"),
            icon = "Interface\\Icons\\INV_Misc_Book_09",
        },
        {
            id = "setup",
            label = Loc("HUB_TAB_SETUP", "Setup"),
            subtitle = Loc("HUB_TAB_SETUP_SUB", "Bars · Display"),
            tip = Loc("HUB_TAB_SETUP_TIP", "Open display options (bars, ticks, fonts, layout)"),
            icon = "Interface\\Icons\\INV_Misc_Gear_01",
        },
        {
            id = "credits",
            label = Loc("HUB_TAB_CREDITS", "Credits"),
            subtitle = Loc("HUB_TAB_CREDITS_SUB", "Thanks · Help"),
            tip = Loc("HUB_TAB_CREDITS_TIP", "Thanks to everyone who helped with Libellus Leti"),
