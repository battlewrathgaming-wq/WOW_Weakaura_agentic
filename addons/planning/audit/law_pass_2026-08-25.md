# THE LAW PASS (RI-79) — FOLDED 2026-08-25 (AI-35 → AL-61): primitives into §5's checked-first table; L21 compressed, its clauses at §4d; the collision decided (bare L-N = this series in-product; cross-product cites qualify). This file is the pass RECORD — the instances, the relates-to citations, and the border notes live here.
