...
⟶ **The tangle is not systemic; it is localised.** DR_Content_1–DR_Process_14 are still one-liners. DR_UI_21 has grown to
...
TELLING"*; `driver_architecture.md`'s **DR_Process_18** is *"LOAD-BEARING ⟹ SOURCEABLE."* Its **DR_Content_17** appears
as `AC-28 [DR_Content_17]`. Two products, same law numbers, different laws.

⟶ **A bare `DR_Process_18` in a cross-read is ambiguous**, and the first measurement of this pass counted the
